...
typedef HNElementWalker = bool Function(Element child, Element? parent);

class HNElementUtils {
  static void walk(BuildContext? context, HNElementWalker walker) {
    if (context == null) {
      return;
    }
  ...
  static void walkElement(Element element, HNElementWalker walker) {
